...
<html>
	...
	<br>
        ...
        <br><br>
			 ...
			 <a href="../../gestionClientes/registroCliente.jsp" type="submit" class="section-btn" role="button" aria-pressed="true">Nuevo Cliente </a>
                ...
                <table id="tblAsistentes" class="table">
                    ...
                    <tbody style="color: black;">
                        <%
                            ...
                            for (PersonaUsuario usuario : facade.getPersonaCliente()) {
