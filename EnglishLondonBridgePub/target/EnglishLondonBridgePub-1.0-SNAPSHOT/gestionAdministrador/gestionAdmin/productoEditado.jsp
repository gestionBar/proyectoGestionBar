...
<%
    ...
    boolean rta = facade.editarProductos(productoMenu, producto, categoriaPr); 
%>
    ...
    <body>
        <form class="form-register" action="" method="post">
            ...
            <%
                if (rta) {
            %>
            <div class="alert alert-info"><h3>Producto  editado correctamente.</h3></div>
            <%
            } else {
            %>
            <div class="alert alert-danger"><h3>Error al editar el Producto</h3></div>
            <%
                }
            %>
            <div class="controls">
