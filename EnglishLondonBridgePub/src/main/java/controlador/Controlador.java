...
public class Controlador extends HttpServlet {
     ...
     */
    PersonaUsuarioDao dao = new PersonaUsuarioDao();
    PersonaUsuario usuario = new PersonaUsuario();
    int r;
        ...
        if(accion.equals("Ingresar")){
            ...
            usuario.setDocumento(numdoc);
            usuario.setContraseña(clave);
          ///  dao.Validar(usuario);
            if (r==1) {
                request.getRequestDispatcher("IndexCliente.html").forward(request, response);
            } else {
